...
def upgrade() -> None:
    ...
    device_type_enum = postgresql.ENUM(
        'nfc_reader', 'led_controller', 'display', 'kiosk',
        name='devicetype', create_type=True
    )
    ...
    led_pattern_enum = postgresql.ENUM(
        'solid', 'pulse', 'chase', 'rainbow', 'breathe', 'wipe',
        name='ledpattern', create_type=True
    )
    nfc_card_type_enum = postgresql.ENUM(
        'egk', 'custom', 'temporary', 'mobile',
        name='nfccardtype', create_type=True
    )
    check_in_method_enum = postgresql.ENUM(
        'nfc', 'qr', 'manual', 'kiosk', 'online',
        name='checkinmethod', create_type=True
    )
    ...
    op.create_table(
        ...
        sa.Column('practice_id', sa.Uuid(as_uuid=True), sa.ForeignKey('practices.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('zone_id', sa.Uuid(as_uuid=True), sa.ForeignKey('zones.id'), nullable=True),
    ...
    op.create_index('ix_iot_devices_device_serial', 'iot_devices', ['device_serial'], unique=True)
    ...
    op.create_table(
        'led_segments',
        sa.Column('id', sa.Uuid(as_uuid=True), primary_key=True),
        sa.Column('zone_id', sa.Uuid(as_uuid=True), sa.ForeignKey('zones.id'), nullable=False),
        sa.Column('controller_device_id', sa.Uuid(as_uuid=True), sa.ForeignKey('iot_devices.id'), nullable=False),
    ...
    op.create_index('ix_led_segments_controller', 'led_segments', ['controller_device_id'])
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Uuid(as_uuid=True), primary_key=True),
        sa.Column('practice_id', sa.Uuid(as_uuid=True), sa.ForeignKey('practices.id'), nullable=False),
        sa.Column('from_zone_id', sa.Uuid(as_uuid=True), sa.ForeignKey('zones.id'), nullable=False),
        sa.Column('to_zone_id', sa.Uuid(as_uuid=True), sa.ForeignKey('zones.id'), nullable=False),
        sa.Column('name', sa.String(100), nullable=False),
    ...
    op.create_index('ix_wayfinding_routes_practice', 'wayfinding_routes', ['practice_id'])
    op.create_index('ix_wayfinding_routes_from_to', 'wayfinding_routes', ['from_zone_id', 'to_zone_id'])
    ...
    op.create_table(
        'patient_nfc_cards',
        sa.Column('id', sa.Uuid(as_uuid=True), primary_key=True),
        sa.Column('patient_id', sa.Uuid(as_uuid=True), sa.ForeignKey('users.id'), nullable=False),
    ...
    op.create_index('ix_patient_nfc_cards_uid_hash', 'patient_nfc_cards', ['nfc_uid_hash'], unique=True)
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Uuid(as_uuid=True), primary_key=True),
        sa.Column('practice_id', sa.Uuid(as_uuid=True), sa.ForeignKey('practices.id'), nullable=False),
        sa.Column('ticket_id', sa.Uuid(as_uuid=True), sa.ForeignKey('tickets.id'), nullable=True),
        sa.Column('device_id', sa.Uuid(as_uuid=True), sa.ForeignKey('iot_devices.id'), nullable=True),
        sa.Column('nfc_card_id', sa.Uuid(as_uuid=True), sa.ForeignKey('patient_nfc_cards.id'), nullable=True),
        sa.Column('check_in_method', check_in_method_enum, nullable=False),
        sa.Column('patient_id', sa.Uuid(as_uuid=True), sa.ForeignKey('users.id'), nullable=True),
        ...
        sa.Column('wayfinding_route_id', sa.Uuid(as_uuid=True), sa.ForeignKey('wayfinding_routes.id'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Uuid(as_uuid=True), primary_key=True),
        sa.Column('practice_id', sa.Uuid(as_uuid=True), sa.ForeignKey('practices.id'), nullable=False),
        sa.Column('queue_id', sa.Uuid(as_uuid=True), sa.ForeignKey('queues.id'), nullable=False),
        sa.Column('zone_id', sa.Uuid(as_uuid=True), sa.ForeignKey('zones.id'), nullable=True),
