...
_$ChatRoomImpl _$$ChatRoomImplFromJson(Map<String, dynamic> json) => _$ChatRoomImpl(
      ...
      adminIds: (json['adminIds'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
      lastMessage: json['lastMessage'] == null ? null : ChatMessage.fromJson(json['lastMessage'] as Map<String, dynamic>),
      createdAt: DateTime.parse(json['createdAt'] as String),
      updatedAt: json['updatedAt'] == null ? null : DateTime.parse(json['updatedAt'] as String),
      isActive: json['isActive'] as bool? ?? true,
    );

Map<String, dynamic> _$$ChatRoomImplToJson(_$ChatRoomImpl instance) => <String, dynamic>{
      'id': instance.id,
...
_$ChatRoomUnreadImpl _$$ChatRoomUnreadImplFromJson(Map<String, dynamic> json) => _$ChatRoomUnreadImpl(
...
Map<String, dynamic> _$$ChatRoomUnreadImplToJson(_$ChatRoomUnreadImpl instance) => <String, dynamic>{
