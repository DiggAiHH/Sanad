...
@router.post("", response_model=PracticeResponse, status_code=status.HTTP_201_CREATED, dependencies=[RequireAdmin])
...
@router.patch("/{practice_id}", response_model=PracticeResponse, dependencies=[RequireAdmin])
...
@router.delete("/{practice_id}", response_model=MessageResponse, dependencies=[RequireAdmin])
